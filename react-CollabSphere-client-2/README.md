...
- **Giảng viên:** _(Nguyễn Văn Chiến)_  
- **Lớp/Nhóm:** _(Corse)_  
- **Học kỳ/Năm học:** _(2)_  
...
|---:|---|---|---|---|
| 1 | _(Điền)_ | _(Điền)_ | Team Lead / BA | Tổng hợp yêu cầu, điều phối, tài liệu |
| 2 | _(Điền)_ | _(Điền)_ | Frontend | UI, routing, tích hợp API |
| 3 | _(Điền)_ | _(Điền)_ | Backend | API, DB, auth, phân quyền |
| 4 | _(Điền)_ | _(Điền)_ | QA/Docs | Test, báo cáo, kịch bản demo |
...
### Liên kết (điền khi nộp)
- Repo frontend: _(điền link)_
- Repo backend: _(điền link nếu có)_
- Demo deployment: _(điền link nếu có)_
